...
<head>
    ...
    <title>Dashboard Periodista</title>
...
<body class="min-h-screen bg-gray-100 mt-16 sm:mt-20">
    ...
    <div class="flex min-h-screen">
        ...
        <div id="mainContent" class="flex-grow p-12 ml-80 transition-all duration-300">
            ...
            <h1 class="text-2xl font-semibold mb-6">Dashboard Principal del Periodista</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #70795B; color: white;">
                            <div>
                                <p class="font-semibold">Noticias Programadas</p>
                                <p class="text-3xl font-bold ">{{ $noticiasProgramadas ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl">schedule</i>
                        </div>
                    </div>

                    <!-- Última Noticia Subida Card (Abajo de las dos anteriores) -->
                    <div class="shadow-md rounded-lg overflow-hidden" style="background-color: #70795B">
                        <div class="px-6 py-4">
                            <p class="text-xl font-semibold text-white mb-2">Última Noticia Subida</p>
                           
                                <h2 class="text-lg font-bold">Título de la Noticia de Ejemplo</h2>
                                <p class="text-lg">Este es un breve resumen de la última noticia subida como ejemplo para la vista.</p>
                                <p class="text-sm text-white mt-2">Publicada el: 2024-01-20</p>
