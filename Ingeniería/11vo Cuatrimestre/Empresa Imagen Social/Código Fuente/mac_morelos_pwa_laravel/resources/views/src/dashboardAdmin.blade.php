...
<head>
    ...
    <!-- Font Awesome (o tu librería de iconos preferida) -->
...
<body class="min-h-screen bg-gray-100 mt-16 sm:mt-20">
    ...
    <div class="flex min-h-screen">
        ...
        <div id="mainContent" class="flex-grow p-12 ml-80 transition-all duration-300">
            ...
            <h1 class="text-2xl font-semibold mb-6">Dashboard Principal del Administrador</h1>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #404534; color: white">
                            <div>
                                ...
                                <p class="text-3xl font-bold">{{ $totalCiudadanos ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl">people</i>
                        </div>

                        <!-- Total Promotores Activos -->
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #70795B; color: white;">
                            <div>
                                <p class="font-semibold">Promotores Activos</p>
                                <p class="text-3xl font-bold ">{{ $totalPromotores ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl">supervisor_account</i>
                        </div>

                        <!-- Total Incidencias Reportadas -->
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #5B6479; color: white;">
                            <div>
                                <p class="font-semibold">Incidencias Reportadas</p>
                                <p class="text-3xl font-bold ">{{ $totalIncidencias ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl ">report_problem</i>
                        </div>

                        <!-- Total Eventos Creados -->
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #765B79; color: white;">
                            <div>
                                <p class="font-semibold">Eventos Creados</p>
                                <p class="text-3xl font-bold">{{ $totalEventos ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl ">event</i>
                        </div>

                        <!-- Total Eventos Activos -->
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #67793d; color: white">
                            <div>
                                <p class="font-semibold">Eventos Activos</p>
                                <p class="text-3xl font-bold">{{ $totalEventosActivos ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl">event_available</i>
                        </div>

                        <!-- Total Noticias Publicadas -->
                        <div class="bg-white shadow-md rounded-lg p-4 flex items-center justify-between" style="background-color: #556b2f; color: white">
                            <div>
                                <p class="font-semibold">Noticias Publicadas</p>
                                <p class="text-3xl font-bold">{{ $noticiasPublicadas ?? 0 }}</p>
                            </div>
                            <i class="material-icons text-4xl">newspaper</i>
                        </div>
                    </div>
                </div>
