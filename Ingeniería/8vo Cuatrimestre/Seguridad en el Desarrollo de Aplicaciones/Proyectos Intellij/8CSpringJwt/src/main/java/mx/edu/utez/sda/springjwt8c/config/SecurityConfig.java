package mx.edu.utez.sda.springjwt8c.config;

import mx.edu.utez.sda.springjwt8c.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests((requests)->{
            ...
            requests.requestMatchers("/auth/admin/test").permitAll();
            requests.requestMatchers("/auth/user/test").permitAll();
        });
