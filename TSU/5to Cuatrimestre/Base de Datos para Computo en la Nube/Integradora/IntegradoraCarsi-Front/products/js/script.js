fetch("http://18.233.124.229:3000/api/products")
            ...
            ${contenido.innerHTML}
              <tr>
                ...
                <td>
                    ...
                    <a href="#">
                    <button class=" btn btn-outline-danger" title="Eliminar" onclick='Borrar(${producto.id_product})'>
...
const saveClient = (data) => {
  fetch("http://localhost:3000/api/products", {
    ...
    .then((data) => {
      console.log(data);
      parent.location.href = "products.html";
    })
    .catch((error) => {
      console.log(error);
    });
