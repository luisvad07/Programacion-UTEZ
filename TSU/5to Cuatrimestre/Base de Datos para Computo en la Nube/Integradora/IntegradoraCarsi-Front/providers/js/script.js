fetch("http://18.233.124.229:3000/api/providers")
    ...
    contenido.innerHTML = `
            ...
            <td>${provider.nombreEmpresa}</td>
                ...
                <td>
                    ...
                    <button class=" btn btn-outline-danger" title="Eliminar" onclick='Borrar(${provider.id_provider})'>
...
const saveProvider = (data) => {
  fetch("http://localhost:3000/api/providers", {
    ...
    .then((data) => {
      console.log(data);
      parent.location.href = "providers.html";
    })
    .catch((error) => {
      console.log(error);
    });
