...
export const ProfileDepartment = () => {
  ...
  const cargarDatos = async () =>{
    ...
    const respuesta = await axios.get(`http://${localhost}:8080/redre/departamento/${sessionId}`);

    datosResponsivos(respuesta.data.obj.nombre, respuesta.data.obj.apellidos, respuesta.data.obj.correo, respuesta.data.obj.divisionAcademica)
  } 
  ...
  const datosResponsivos = (nombre, apellidos, correo, divisionAcademica) =>{
    setNombre(nombre)
