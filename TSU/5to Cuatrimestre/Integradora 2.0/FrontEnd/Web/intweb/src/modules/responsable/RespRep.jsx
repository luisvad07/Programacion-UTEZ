...
export const RespRep = () => {

    const [estudiante, setEstudiante] = useState([]);
    const [sessionId, setSessionId] = useState(localStorage.getItem('sesionId'));
    const url = `http://${localhost}:8080/redre/estudiante/responsable/${sessionId}/hasReport`
    ...
    const aprobar = async () => {
        ...
        axios.put(`http://${localhost}:8080/redre/mensajesResponsables/aprobado/${estudianteMatricula}`)
        .then((response) => {
    ...
    const rechazarReporte = () => {
        ...
        parametros = {
            ...
            nombreR: localStorage.getItem('nombre')
        }
        enviarMensaje(parametros)
    }

    const enviarMensaje = async (parametros)  => {
        const url = `http://${localhost}:8080/redre/mensajesResponsables/Rs/`
