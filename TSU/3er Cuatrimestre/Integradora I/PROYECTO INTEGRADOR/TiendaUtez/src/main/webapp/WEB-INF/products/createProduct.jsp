...
<div class="p-4 mt-1 rounded rounded-3 " id="fondo">
    ...
    <div id="fondo-blanco" class="rounded p-4 shadow">
        ...
        <main class="container-fluid   ">
            ...
            <form class="row" action="ProductServlet?action=createNormal" method="post" enctype="multipart/form-data">
                <!---------------------- Lado izquierdo ----------------------------->
                        ...
                        <div class="row  ">
                            ...
                            <div class="col-12 col-lg-11 col-md-12  p-0 px-md-2  mb-3">
                                <input type="text" class="form-control form-control-lg fs-4"
                                       placeholder="Ingrese el nombre " id="nameProduct" name="nameProducts">
                            </div>
                            ...
                            <div class="col-12 col-lg-11 col-md-12 p-0 px-md-2 ">
                                ...
                                <textarea name="shortDescription" class="form-control col-12 col-lg-11 col-md-12" rows="4" placeholder="Caracteristicas generales del producto" id="shortDescription"></textarea>
                            </div>
                            ...
                            <div class="mt-2 p-0 p-md-2 ">
                                ...
                                <div class="mb-3 col-12 col-lg-11 col-md-12">
                                    ...
                                    <input class="form-control form-control-lg" type="file"  id="mainImage" name="mainImage" >
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col col-lg-7 col-md-6 col-sm-12 col-12 px-lg-3 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-11 col-md-12  p-0 px-md-2  mb-3 " >
                            ...
                            <textarea rows="4" name="longDescription" class=" content  border border-success rounded" id="longDescription"></textarea>
                        </div>
