...
public class ProductUserBean {
    ...
    public ProductUserBean(int id_products, String name, String description, String descriptionLong, String type, int status, String imageToShow, InputStream imageToInsert, int delete, CategoryBean category, BeanOffer offer, List<ImagesBean> imagesSecondaries, List<CombinationPDBean> combinations) {
