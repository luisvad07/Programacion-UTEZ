 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "utez", wsdlLocation = "http://localhost:7878/Services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("utez", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7878/Services?wsdl");
    ...
    public Services getServicesPort() {
        return super.getPort(new QName("utez", "ServicesPort"), Services.class);
    }
    ...
    public Services getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("utez", "ServicesPort"), Services.class, features);
    }
