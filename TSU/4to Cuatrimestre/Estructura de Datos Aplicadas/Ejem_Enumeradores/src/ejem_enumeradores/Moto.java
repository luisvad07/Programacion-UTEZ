...
public class Moto implements Vehiculo{
    ...
    public String toString() {
        return "Auto{" + "Codigo= " + codigo + "Marca=" + Marca + ", Modelo=" + Modelo + ", Anio=" + Anio + ", Color=" + Color + ", num_motot=" + num_motor + "}";
    }
    ...
    public void alta() {
        this.s.useDelimiter("\n");
            ...
            System.out.print("Introduzca No.Motor: ");
            this.setNum_motor(s.nextLine());
    ...
    System.out.print("Ingresa el Codigo del Auto que deseas buscar: ");
		...
		System.out.println("Codigo: " + this.getCodigo());
                ...
                System.out.println("No. Motor: " + this.getNum_motor());
